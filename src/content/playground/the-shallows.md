...
const initialFishCount = Math.min(428, Math.max(138, Math.floor(initialArea / 616)));
...
function rescaleAll(oldW, oldH) {
  ...
  const newBasePop = Math.min(428, Math.max(90, Math.floor((w * h) / 616)));
...
const fishCount = Math.min(428, Math.max(138, Math.floor((w * h) / 616)));
const fish = [];
...
let basePop = Math.min(428, Math.max(90, Math.floor((w * h) / 616)));
...
regenerateWorld = function() {
  ...
  basePop = Math.min(428, Math.max(90, Math.floor((w * h) / 616)));
  popTarget = basePop * (0.7 + Math.random() * 0.3);
  const newFishCount = Math.min(428, Math.max(138, Math.floor((w * h) / 616)));
